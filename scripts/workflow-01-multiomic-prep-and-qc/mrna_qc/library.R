qc_mrna_normalized <- function(mrna_quant_path, data_subtype_path) {
  #makes histogram of RNA_Log2_Normalized values
  #test values
  #mrna_quant_path = "all_genes_no_intersect.rds" ; data_subtype_path = "mogsa_meta.tsv"
...
qc_mrna_raw <- function(mRNA_path) {
